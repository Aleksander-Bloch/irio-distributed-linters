...
subprocess.run(["python3", "machine_management.py", "-host", machine_management_host, "-port", machine_management_port,
                "-lba", load_balancer_addr])

# run load balancer
subprocess.run(["python3", "load_balancer.py", "-host", load_balancer_host, "-port", load_balancer_port,
